# ⚠️ ARCHIVED / DEPRIORITIZED — June 2026

**This project is archived and no longer active — superseded by [WNAC](https://github.com/Logos52/wnac).**

WNAB ("We Need A Budget") was originally intended as a YNAB-style budgeting tool built as a clone/fork
of [Actual Budget](https://github.com/actualbudget/actual). We got the fork running and a round-trip
Obsidian bridge working — then ran into the classic question: **do we actually need this?**

A full envelope-budgeting app like YNAB demands constant manual upkeep — categorizing, reconciling,
micromanaging every transaction. In the age of AI it would make more sense to build an
**AI-blended budgeting tool** that does the synthesis and bookkeeping for us, rather than one that requires micromanagement. What we settled on is [WNAC](https://github.com/Logos52/wnac), Wedge Needs a Copilot, the successor, built using some of Copilot's design principles and some features from Monarch + Cleo, which are AI blended budgeting environments. Please see WNAC for the repository code & readme.

Everything below is the original upstream Actual Budget README, kept for reference only.
