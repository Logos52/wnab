...
type Actual = {
  ...
  // wnab snapshot export: writes the JSON to a fixed path the main process
  // owns (~/Documents/Finances/wnab/snapshot.json). See docs/SNAPSHOT-SCHEMA.md.
  saveWnabSnapshot: (contents: string) => Promise<void>;
